...
## Download Datasets
- Mock attack dataset: [US - Mock Attack Cam 1, 5, 7](https://huggingface.co/datasets/jsalazar/US-Real-time-gun-detection-in-CCTV-An-open-problem-dataset/blob/main/weapons_images_2fps.zip){:target="_blank" rel="noopener"}.
